package com.eleven.musicnavigation;
...
public class BottomNavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    private int[] selectIcon = {R.drawable.nav_web_on, R.drawable.nav_download_on};
    ...
    //选中时icon
    private int[] normalIcon = {R.drawable.nav_web_off, R.drawable.nav_download_off};

    private int textColor = Color.parseColor("#5fce30");
    private ImageButton img2, img3;
    ...
    private void setUnSelect(int position) {
        switch (position) {
            case 0:
                img2.setImageResource(normalIcon[0]);
                tv_second.setVisibility(GONE);
                break;
            case 1:
                img3.setImageResource(normalIcon[1]);
